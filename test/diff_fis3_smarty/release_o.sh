...
#    chmod 777 ${PLACE_OUTPUT_PATH}
    ...
    do
        ...
        echo "node ${FISP_PATH}/bin/fis release -f ${HAO123_CODE_PATH}/$module/fis-conf.js -d ${HAO123_OUTPUT_PATH}/output_o_new --no-color"
        node ${FISP_PATH}/bin/fis release -f ${HAO123_CODE_PATH}/$module/fis-conf.js  -d ${HAO123_OUTPUT_PATH}/output_o_new --no-color --verbose
...
#    chmod 777 -R ${PLACE_OUTPUT_PATH}/output_o_old
    ...
    do
        cd ${HAO123_CODE_PATH}/$module
        node /home/work/bin/fis3 release -f ${HAO123_CODE_PATH}/$module/fis-conf.js -d ${HAO123_OUTPUT_PATH}/output_o_old --no-color --verbose
    done
