...
UE.I18N['zh-cn'] = {
    'labelMap':{
        'anchor':'锚点', 'undo':'撤销', 'redo':'重做', 'bold':'加粗', 'indent':'首行缩进', 'noindent': '取消缩进', 'snapscreen':'截图',
    ...
    'paragraph':{'p':'正文', 'h1':'标题', 'h2':'章', 'h3':'节', 'h4':'小节', 'h5':'标题 5', 'h6':'标题 6', 'blockquote': '引用', 'inscribed': '落款', 'legends': '图注'},
    'fontfamily':{
        'songti':'宋体',
        'kaiti':'楷体',
        'heiti':'黑体',
