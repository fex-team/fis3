...
var loginTpl  = '<ul class="account_list">',
    liTpl     = '<li class="account_li account_li_#{nam}#{other}" typ="#{typ}" title="#{title}"><span></span></li>',
...
if(manyLogin) {
	...
	loginTpl += '</ul><p class="account_login-tip_m">' + _conf.newLoginTxt + '</p>';
} else {
	loginTpl = '<p class="login-tip_con">#{txtDefaultBtn}</p>';
}

var signTpl = '<p class="accout_logout_sign"><a href="' 
              + '#{activitySignUrl}" class="account_logout_sign_btn"'
              + '>#{activitySign}</a></p>';

var tpl = '<div class="account_login-tip">'
          + loginTpl
	      + '</div><div class="account_logout-tip'
	      + (isActivi ? ' account_logout-act">' : '">')
	      + '<img /><div class="account_logout_content">'
	      + '<p class="account_logout_name"></p>'
	      + '<p class="account_logout_email"></p>'
	      + (isActivi ? signTpl : '')
	      + '<p class="account_logout_con">'
	      + '<a href="#" target="_self" class="account_logout_btn">'
	      + '#{logoutTxt}</a></p></div></div>';
