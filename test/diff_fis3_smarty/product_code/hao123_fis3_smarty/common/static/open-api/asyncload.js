(function() {
    ...
    */
    ...
    function asyncLoad(param) {
        ...
        // 开放平台
        param.iframeUrl && arr.push( 'iframeUrl=' + encodeURIComponent( param['iframeUrl'] ) );
        param.width && arr.push( 'width=' + param['width'] );
        param.height && arr.push( 'height=' + param['height'] );
        // param.appid && arr.push( 'appid=' + param['appid'] );
