...
require("common:widget/ui/jquery/widget/jquery.ui.autocomplete.html/jquery.ui.autocomplete.html.js");
 $(function(){
        ...
        $(".search-form form").submit(function(e){
           ...
           UT.send({type:"click",position:"quicksearch",value:searchFormInput.val(),url:pageUrl});
           var req = /\?$/;
	       ...
	       if(!req.test($(this).attr("action"))){
			...
			setTimeout(function(){
                ...
                $("#hotsite .hotsite-item").removeClass("hotsite_hover");
            }, 100);
        }); 	 
         /*隐藏提示语*/   
            ...
            $("#custom_bar").click(function(e){
                ...
                custom_list.slideToggle("fast",function(){
                    var isFirst = jQuery.cookie("isOpensitelist"),
                        isOpen = (isFirst === null) ? 0 : jQuery.cookie("isOpensitelist")^1;
