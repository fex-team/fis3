    ...
    <div class="l-w cf">
        <div class="l-l cf<%if !empty($body.alignLeftStyle)%> l-l-left<%/if%>">
            ...
            <div class="s">
                ...
                <div class="s-bd cf">
                <form action="<%$head.yahooActionUrl|default:'/yahoo_search-partner'%>" id="searchForm" target="_self">
                    <div class="fl s-ipt">
...
<div class="l-ft">
    <div class="l-w s-wrap cf">
        <div class="l-l">
            <div class="s">
                <div class="s-bd cf">
                <form action="/yahoo_search-partner" id="searchForm2" target="_self">
                    <div class="fl s-ipt">
...
<%widget name="lv2:widget/yahoo-search-partner/yahoo-search-partner.tpl"%>
<%/block%>