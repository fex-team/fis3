...
<%widget name="lv2:widget/nav-list-h/`$head.dir`/`$head.dir`.tpl"%>
	<div class="nav-lv2<%if $head.dir=='rtl'%> s-mrm<%else%> s-mlm<%/if%> favsite-count" id="navList">
	...
	<%script%>
		require.async('lv2:widget/nav-list-h/nav-list-h.js',function(navList){
			navList();
		});
	<%/script%>
