...
cycletabs.NavUI.prototype = {
    ...
    _render: function(){
        ...
        //strArr.push(['<li class="nav-item" data-id="'+data[index][that.idKey]+'" data-index="'+index+'">'+data[index].content+'</li>'].join(''));
            if (that.completeLi) {
                var $item = $('<li class="nav-item" data-id="'+idKey+'" data-index="'+index+'" title="'+data[index].content+'"><i class="nav-item_'+idKey+'"></i><span class="title">'+data[index].content+'</span></li>');
