	...
	<%*   声明对ltr/rtl的css依赖    *%>
	<%if $head.dir=='ltr'%> <%require name="lv2:widget/site-list-v-new/lottery/ltr/ltr.css"%> <%else%> <%require name="lv2:widget/site-list-v-new/lottery/rtl/rtl.css"%> <%/if%>
	<%foreach $data as $linksValue%>
		<dl class="box-lv2 s-mbl mod-lottery">
