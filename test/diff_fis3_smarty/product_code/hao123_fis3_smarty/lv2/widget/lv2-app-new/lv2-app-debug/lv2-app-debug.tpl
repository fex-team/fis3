...
<%widget name="lv2:widget/lv2-app-new/lv2-app-debug/`$head.dir`/`$head.dir`.tpl"%>
...
<%script%>
	require.async('lv2:widget/lv2-app-new/lv2-app-debug/lv2-app-debug.js',function(extAppDebug){
		extAppDebug.init();
	});
<%/script%>
