...
(function(c, b, e) {
    ...
    c.CBPContentSlider.prototype = {
        _init: function(f) {
            ...
            this.transEndEventName = g[d.prefixed("transition")] + ".cbpContentSlider";
            if (this.support) {
        ...
        _initEvents: function() {
            var f = this;
            this.$tabs.on("click.cbpContentSlider", function(k) {
                var g = c(this).index();
                console.log(g);
    ...
    c.fn.cbpContentSlider = function(g) {
        if (typeof g === "string") {
            var f = Array.prototype.slice.call(arguments, 1);
            this.each(function() {
                var h = c.data(this, "cbpContentSlider");
                if (!h) {
                ...
                if (!c.isFunction(h[g]) || g.charAt(0) === "_") {
                    a("no such method '" + g + "' for cbpContentSlider instance");
                    return
                }
                h[g].apply(h, f)
            })
            ...
            this.each(function() {
                ...
                if (h) {
                    ...
                    h = c.data(this, "cbpContentSlider", new c.CBPContentSlider(g, this))
                }
            })
        }
        return this
