...
/**
 * 用来创建 File 对象， 更多细节请查看 {@link module:fis.file~File File} 说明。
 *
 * ```js
 * var file = fis.file(root, 'static/xxx.js');
 * ```
 *
 * @module {Function} fis.file
 * @see {@link module:fis.file~File File 类说明}
 */
 ...
 * @return {@link module:fis.file~File File 对象}
 * @example
