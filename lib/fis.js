...
fis.require = function() {
  // todo 如果 local 没找到，应该去 global 找。
  ...
  // var type = name.substring(0, idx);
  // var filename = name.substring(idx + 1);
  // var pluginName = pth.join(PLUGIN_DIR, type, filename + '.js');

  // if (fis.util.exists(pluginName)) {
  //   return fis.require._cache[name] = require(pluginName);
  // }
