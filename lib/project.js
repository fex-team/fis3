...
exports.getSource = function() {
  var parttens = fis.config.get('project.startPoint');
...
exports.getSourceByParttens = function(parttens, opts) {
  parttens = parttens || fis.config.env().get('project.files');
  ...
  opts = _.assign({
    ...
    matchBase: true,
    ignore: fis.config.env().get('project.ignore')
  }, opts || {});
